...
from data.dataloader import get_kolomogrov_flow_data_loader_train_only
...
def main(data_path, model_type, model_config, checkpoint_path, log_file, new_run, no_segment, seg_model_name, seg_model_config):
    ...
    train_dataloader = get_kolomogrov_flow_data_loader_train_only(data_path, batchsize=local_batch_size)
