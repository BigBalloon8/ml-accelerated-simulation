...
def get_mask(x, segment_model, num_classes:int):
    with torch.no_grad():
...
def main(data_path, model_type, model_config, checkpoint_path, log_file, new_run, seg_model_name, seg_model_config, num_classes):
    ...
    model, metadata, opt_state = get_model(model_type, model_config, checkpoint_path, logger, new_run, num_classes-1)
...
if __name__ == "__main__":
    ...
    ap.add_argument("--seg_model_name", default="seg_v3", help="segment model name")
